...
export default function RulesPage() {
  return <div className="space-y-5">
    ...
    <section className="brand-card p-5 sm:p-6"><h2 className="text-2xl font-black text-white">Making picks</h2><p className="mt-3 text-sm leading-6 text-slate-300">On a normal matchday, assign Home Winner, Away Winner, Draw, Team to Win, Team to Lose, Team to Score, and Clean Sheet to seven different fixtures. One fixture cannot be used twice; normally about three fixtures remain unused.</p><p className="mt-3 text-sm leading-6 text-slate-300">Also predict Total Goals across the full matchday. It does not consume a fixture. A submitted entry always requires all seven unique fixture categories plus Total Goals. Postponed and cancelled fixtures are unavailable for new picks.</p></section>
